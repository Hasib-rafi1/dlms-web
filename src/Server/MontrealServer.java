...
import com.web.service.impl.MontrealClass;



public class MontrealServer {
	
	public static MontrealClass montrealClass;
	public static void main(String args[])
	{
		try {
			System.out.println("mcGill Server Started...");
			montrealClass = new MontrealClass();
			Endpoint endpoint = Endpoint.publish("http://localhost:8082/montreal", montrealClass);
			
			
			
			Runnable task = () -> {
				receive(montrealClass);
			};
