...
import com.web.service.impl.ConcordiaClass;



public class ConcordiaServer {
	public static ConcordiaClass concordiaClass;
	public static void main(String args[])
	{
		try {
			System.out.println("Concordia Server Started...");
			concordiaClass = new ConcordiaClass();
			Endpoint endpoint = Endpoint.publish("http://localhost:8080/concordia", concordiaClass);
			
			

			System.out.println("Concordia Server ready and waiting ...");
			Runnable task = () -> {
				receive(concordiaClass);
			};
