...
public class ConcordiaClass implements WebInterface{
	...
	public ConcordiaClass(){
		super();
		Map<String, Item> itemsMap = new HashMap<>();
		itemsMap.put("CON1010", new Item("CON1010", "Distributed System", 10));
		itemsMap.put("CON1011", new Item("CON1011", "Absoulate Java", 11));
		itemsMap.put("CON1012", new Item("CON1012", "Data Structure", 5));
